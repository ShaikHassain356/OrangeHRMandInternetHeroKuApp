...
public class ExtentReportManager implements ITestListener {
    ...
    public void onStart(ITestContext testContext) {
        ...
        extent.setSystemInfo("Application", "OrangeHRMandInternetHerokuApp");
    ...
    public void onTestFailure(ITestResult result) {
        ...
        try {
            String imgPath = new BaseTest().captureScreen(result.getName()); // here we are creating basetest class object, so new driver will be created, for that we need to make basetest driver as static
